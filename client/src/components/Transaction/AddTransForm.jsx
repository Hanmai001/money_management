  ...
  return (
    <div className={clsx(styles.modal)}>
      <div className={clsx(styles.modalContainer)}>
        ...
        <div className="row">
          <button className={clsx("col-3", styles.wallet)}>
            <p>Name</p>
          ...
          <button className={clsx("col-3", styles.categ)}>
            <p>Select</p>
        ...
        <div className={clsx("row", styles.row2)}>
          <button className={clsx("col-3", styles.date)}>
            <p>Date</p>
            <i className="fa-solid fa-circle-chevron-right"></i>
            <p>28/08/2022</p>
          </button>
          <div className={clsx("col-6", styles.note)}>
            <p>Note</p>
            <input placeholder="Your note here"></input>
          </div>
        </div>
