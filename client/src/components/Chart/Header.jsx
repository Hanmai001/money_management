...
function Header(props) {
    ...
    return (
        <div className={clsx("row", styles.header)}>
            ...
            <div
                className={clsx("col-6", styles.lstWallet)}
                ...
                <div className={styles.nav}>
                    <div>
                        <div className={styles.wallet1}>
                            ...
                            <i
                                className={clsx("fa-solid fa-caret-down")}
                                style={{ marginLeft: "0.5rem" }}
                                onClick={handleClick}
                            ></i>
                        </div>
